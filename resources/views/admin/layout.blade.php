...
<body>
    <div class="d-flex">
        {{-- Sidebar --}}
        <div class="d-flex flex-column p-3 text-white sidebar-bg position-fixed" style="width: 190px; height: 100vh; background-color: #282d33;">
            ...
            <ul class="nav flex-column fs-5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('categories.index') }}"><i class="bi bi-justify"></i> Categories</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('genres.index') }}"><i class="bi bi-vector-pen"></i> Genres</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('users.index') }}"><i class="bi bi-people-fill"></i> Customers</a>
                </li>
            </ul>
        </div>
